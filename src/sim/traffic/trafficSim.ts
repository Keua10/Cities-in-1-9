...
export class TrafficSim {
  ...
  constructor(private world:World,private macro:MacroSim,private congestion:CongestionMap,assignment:AssignmentTable){this.router=new Router(world,congestion);this.citizens=new CitizenPool(world,macro,assignment);}
