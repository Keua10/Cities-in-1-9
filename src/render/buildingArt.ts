...
export const BUILDING_NAMES: readonly (readonly (readonly string[])[])[] = [
  [
    ['기와 단독주택', '슬레이트 주택', '벽돌 연립주택', '정원 주택'],
    ['발코니 연립주택', '중정 공동주택', '테라스 주택', '저층 아파트'],
    ['정원 저택', '테라스 공동주택', '중정 아파트', '복층 공동주택'],
  ],
  [
    ['차양 상점', '모퉁이 상점', '유리 전면 상점', '목조 상점'],
    ['거리 상가', '유리 업무동', '아케이드 상가', '모퉁이 업무동'],
    ['아트리움 상가', '유리 업무 타워', '테라스 상가', '중정 업무단지'],
  ],
  [
    ['벽돌 작업장', '박공지붕 작업장', '하역형 작업장', '톱니지붕 작업장'],
    ['톱니지붕 공장', '저장탱크 공장', '하역형 공장', '분동형 공장'],
    ['대형 생산동', '저장탱크 산업단지', '하역장 산업동', '분동형 산업단지'],
  ],
];
