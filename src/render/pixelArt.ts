...
export const PIXEL_PALETTE = {
  ...
  plasterDark: '#a86f4f',
  terracotta: '#c8452d',
  terracottaLight: '#ef7542',
  terracottaDark: '#792d2b',
  slate: '#3d6076',
  slateLight: '#7593a3',
  slateDark: '#273f4d',
  roof: '#607783',
...
export const MATERIAL = {
  ...
  plaster: ['plasterLight', 'plaster', 'plasterDark'],
  terracotta: ['terracottaLight', 'terracotta', 'terracottaDark'],
  slate: ['slateLight', 'slate', 'slateDark'],
